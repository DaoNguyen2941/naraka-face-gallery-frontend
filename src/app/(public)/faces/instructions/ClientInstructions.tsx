      ...
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        <div className="backdrop-blur-md bg-black/70 rounded-2xl shadow-lg p-6 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p> Ở giao diện game, vào phần tướng:</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b1.png"
              alt="Chọn nhân vật"
            />
            <p>  - Chọn tướng bạn muốn áp dụng mẫu làm đẹp, sau đó chọn:Dịch Dung.</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b2.png"
              alt="Chọn dịch dung"
            />
            <p> - Sau đó chọn ô có dấu + để tạo dung mạo mới:</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b3.png"
              alt="Chọn dấu +"
            />
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>   - Ở giao diện trỉnh sửa khuân mặt chọn Nhập:</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b4.png"
              alt="Chọn file QR"
            />
            <p>
              - Một cửa sổ mở ra để chọn file. Chọn ảnh QR-Code từ thư mục bạn đã tải ảnh về đó ( Ở trường hợp của tôi nó ở phần dowload),
              sau đó chọn Open. Hệ thống sẽ tự động áp dụng kiểu trang điểm/mặt cho nhân vật:</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b5.png"
              alt="Chọn file QR"
            />
          </section>
          ...
          <section className="space-y-3">
            ...
            <p> - Sau khi mẫu mặt được áp dụng, nhấn Lưu thành số liệu mới:</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b6.png"
              alt="Lưu mẫu mặt"
            />
            <p>  - Sau đó đặt tên và bấm <strong>Lưu thành số liệu mới</strong> vậy là bạn có thể sử dụng mẫu mặt này bất cứ lúc nào.</p>
            <InstructionImage
              src="https://cdn.narakaqrface.com/public/instructions/b7.png"
              alt="Lưu mẫu mặt"
            />
          </section>
